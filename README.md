...
* Liste des projets : Permets de lister tous les projets déjà créé et accépder à leurs fonctionnalitées 
  ...
  * *Détail :* Permet de visualiser le détail du projet, les différentes lignes qui le compose, ses fichiers (télécharger, supprimer et ajouter), génération d'un PDF, ainsi que différentes info 
